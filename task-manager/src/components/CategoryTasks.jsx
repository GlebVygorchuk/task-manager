...
export default function CategoryTasks({ title, onReturn, date, categoryId}) {
    ...
    return (
        ...
        <div className="category-tasks__header">
            <h1 style={{maxWidth: '70%', textAlign: 'center', fontSize: '50px'}} className="category-tasks__title"><span style={{color: currentColor === undefined ? 'black' : currentColor}} className="highlight">{title}</span></h1>
        </div>
