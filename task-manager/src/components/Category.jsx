    ...
    return (
        <div id={categoryId} className="taskboard__category-wrapper">
            <div style={{backgroundColor: color}} onClick={onClick} className="taskboard__category">
                <div className="taskboard__category__content-wrapper">
                    {content}
                </div>
                <div className="taskboard__category__svg-wrapper">
                    <svg onClick={(e) => handleDelete(e, categoryId)} style={{boxShadow: 'none', borderRadius: '10px', background: 'transparent'}} className="option" xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" viewBox="0 0 16 16">
