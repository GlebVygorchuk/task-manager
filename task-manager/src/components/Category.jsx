...
export default function Category({content, onClick, categoryId, date, color}) {
    ...
    return (
        <div 
        id={categoryId} 
        className="taskboard__category-wrapper">

            <div 
            style={{backgroundColor: color}} 
            onClick={onClick} 
            className="taskboard__category">

                <div 
                className="taskboard__category__content-wrapper" 
                style={color === 'white' ? {color: 'black'} : {color: 'white'}}>

                    {content}

                    <div 
                    style={color === 'white' ? {backgroundColor: 'black'} : {backgroundColor: 'white'}} 
                    className="taskboard__category__underline">
                    </div>
                ...
                <div className="taskboard__category__svg-wrapper">
                    ...
                    <svg 
                    onClick={(e) => handleDelete(e, categoryId)} 
                    style={color === 'white' ? {boxShadow: 'none', borderRadius: '10px', background: 'transparent', fill: 'black'} : {boxShadow: 'none', borderRadius: '10px', background: 'transparent'}} 
                    className="option" 
