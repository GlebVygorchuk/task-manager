    ...
    return (
        ...
        <header className="main__header">
            ...
            <div className="profile-information">
                <h2 className="username">{`Добро пожаловать, ${auth.currentUser.displayName}!`}</h2>
            ...
            <div className={`main__header__info ${showProfile ? 'show-profile' : null}`}>
                ...
                <p>Имя: <span className="info-field">{auth.currentUser.displayName}</span></p>
                <p>E-Mail: <span className="info-field">{auth.currentUser.email}</span></p>
                <button 
